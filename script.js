...
"Tambora", "Kerinci", "Jaya", "Rantemario",
  ...
  "Sinop", "Samsun", "Zonguldak", "Bartın",
  "Hatay", "Mersin", "Adana", "Kilis",
  "Edirne", "Tekirdağ", "Çanakkale", "İstanbul",
  "Iğdır", "Ağrı", "Kars", "Ardahan",
  "Çukurova", "Marmara", "Ege", "İç Anadolu",
  "Kocaeli", "İstanbul", "Bursa", "İzmir",
  "Akdeniz", "Ege", "Karadeniz", "Kapadokya",
  "İzmir", "Mersin", "İstanbul", "Antalya",
  "Atatürk Barajı", "Karakaya Barajı", "Keban Barajı", "Hirfanlı Barajı",
  "İstanbul", "Ankara", "İzmir", "Bursa",
  "Olimpos-Beydağları", "Göreme", "Milli Park", "Kazdağları",
  "Kızılırmak", "Sakarya", "Fırat", "Yeşilırmak",
  "Ankara", "İzmir", "Bursa", "Adana",
  "Hazar", "Beyşehir", "Acıgöl", "Meke",
  "Mersin", "İzmir", "İstanbul", "Antalya",
  "Bor", "Kömür", "Bakır", "Altın",
  "Şanlıurfa", "Siirt", "Mardin", "Batman",
  "Konya Ovası", "Çukurova", "Thrakya Ovası", "Antalya Ovası",
  "Göbeklitepe", "Çatalhöyük", "Hacılar", "Nevalı Çori",
  "Tuz Gölü", "Beyşehir Gölü", "Eğirdir Gölü", "Acı Göl",
  "Antalya", "İstanbul", "Muğla", "İzmir",
  "İstanbul", "Kocaeli", "İzmir", "Bursa",
  "Fırat-Dicle", "Meriç-Ergene", "Sakarya", "Kızılırmak",
  "Doğu Anadolu", "Karadeniz", "Ardahan", "Erzurum",
  "Gökçeada", "Bozcaada", "Marmara", "Büyükada",
  "İstanbul Üniversitesi", "Ankara Üniversitesi", "İzmir Ekonomi Üniversitesi", "Hacettepe Üniversitesi",
  "Van Gölü", "Tuz Gölü", "Beyşehir Gölü", "Eğirdir Gölü",
  "Güneydoğu Anadolu", "Çukurova", "Marmara", "Ege",
  "İstanbul-Ankara", "Ankara-Kars", "İzmir-Adana", "Eskişehir-Konya",
  "Ovit Tüneli", "Marmaray Tüneli", "Avrasya Tüneli", "Bolu Tüneli",
  "Derinkuyu Yeraltı Şehri", "Karaca Mağarası", "Damlatas Mağarası", "Damlataş Mağarası",
  "İstanbul Havalimanı", "Atatürk Havalimanı", "Antalya Havalimanı", "İzmir Adnan Menderes Havalimanı",
  "İstanbul", "Ankara", "İzmir", "Bursa",
  "Atatürk Barajı Göleti", "Hirfanlı Barajı Göleti", "Oymapınar Barajı Göleti", "Keban Barajı Göleti",
  "Sarıçiçek", "Demirkazık", "Çobandede", "Şenyayla",
  "Manyas Gölü", "Sapanca Gölü", "Uluabat Gölü", "Beyşehir Gölü",
  "Marmara", "İç Anadolu", "Ege", "Karadeniz",
  "Ankara-Kars", "İstanbul-Ankara", "Eskişehir-Konya", "Ankara-Sivas",
  "Yozgat Bozok Milli Parkı", "Olimpos-Beydağları Milli Parkı", "Kazdağları Milli Parkı", "Göreme Milli Parkı",
  "Çukurova Ovası", "Konya Ovası", "Thrakya Ovası", "Antalya Ovası"
];
